...
//	private OptionService optionService;
	...
	@GetMapping("/{id}")
	public ResponseEntity<ProductModelResponse> getProductById(@PathVariable("id") Integer id ){
	...
	public ResponseEntity<ProductModelResponse> createProduct(@Valid @RequestBody ProductModelRequest motorbikeModel) throws Exception{
	...
	public ResponseEntity<ProductModelResponse> updateProduct(@PathVariable("id") Integer id,@Valid @RequestBody ProductModelRequest motorbikeModel) throws Exception{
		if(motorbikeModel == null) {
			return new ResponseEntity<>(HttpStatus.NO_CONTENT); 
		}
